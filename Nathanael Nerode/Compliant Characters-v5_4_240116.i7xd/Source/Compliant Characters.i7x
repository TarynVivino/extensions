Version 5.4.240116 of Compliant Characters by Nathanael Nerode begins here.
...
Include Reparse by Nathanael Nerode.  [This includes the reparsing machinery.]
...
Check ordering something to (this is the reparse as command rule):
	[This calls into Reparse by Nathanael Nerode, and will give a command clarification]
	reparse with "[noun], [the quote-stripped topic understood]";
	stop the action;
